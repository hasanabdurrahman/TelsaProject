    ...
    <nav class="navbar navbar-expand-lg">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          ...
          >
            <li class="nav-item">
              <a class="nav-link" href="homeumum.php">Home</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="dataagen.php">Agen</a>
            </li>
          </ul>
...
<div class="bgdata">
  <div class="container">
    <h4 class="teksjudul">Data Agen</h4>
    <center>
    <input type="text" id="searchdata" class="searchdata" placeholder="Cari Agen...">
    </center>
  </div>
</div>
                      ...
                      $cards = [];
                        while($row = $result->fetch_assoc()) {
                          $cards[] = '<div class="col-4">
                                      <div class="card">
                                        <img class="profile" alt="profile agen ' . $row["nama"] . '" src="image/' . $row["image"] . '.png"/>
                                        <strong>Agen ' . $row["distrik"] . '</strong>
                                        <span>Nama: Agen ' . $row["nama"] . '</span>
