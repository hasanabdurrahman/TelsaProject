...
<form action="action_tambah_produk.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-3 ms-auto">
            <button class="btn-orange" href="produk-saya.php" style="margin-right: 10px;">Batal</a>
            <button type="submit" class="btn-orange">Unggah</button>
        </div>
    </div>
